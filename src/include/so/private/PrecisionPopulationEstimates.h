 ...
 */
#ifndef _SO_PRIVATE_PRECISIONPOPULATIONESTIMATES_H
#define _SO_PRIVATE_PRECISIONPOPULATIONESTIMATES_H
...
struct so_PrecisionPopulationEstimates {
	so_MLE *MLE;
	so_Bayesian_PPE *Bayesian;
	so_OtherMethod_PPE *OtherMethod;
	int in_MLE;
	int in_Bayesian;
	int in_OtherMethod;
	int reference_count;
